...
/**
 * The Class AvvisoPagamentoDatasource.
 */
...
//	private Logger log = null;
	...
	/**
 * Instantiates a new avviso pagamento datasource.
 *
 * @param dataSource the data source
 */
public AvvisoPagamentoDatasource(List<AvvisoPagamentoInput> dataSource) {
